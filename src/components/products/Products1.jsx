...
//   const { loading, products, pagination, error, } = useSelector((state) => state.product);
...
import { useDispatch, useSelector } from "react-redux";
import { fetchProducts } from "@/redux/action/product/productAction";
import Pagination from "../common/Pagination"; // Updated Pagination
        ...
        <div className="container">
          ...
          <div className="wrapper-control-shop">
            ...
            {activeLayout === 1 ? (
              <div className="tf-list-layout wrapper-shop" id="listLayout">
                <Listview
                  // Use sorted products if available; otherwise fall back to API products
